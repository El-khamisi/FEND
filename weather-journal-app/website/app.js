...
const eventListener = function() {
    ...
    const APIcall = `https://api.openweathermap.org/data/2.5/weather?zip=${zip.value}&appid=${apiKey}`;
...
const getData = async(url = '') => {
    ...
    try {
        ...
        document.getElementById('city').innerHTML = `Weather For ${allData[0].city}`
